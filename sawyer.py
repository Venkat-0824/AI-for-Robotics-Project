...
class sawyer:
	...
	def reset(self):
		self.sawyerId = p.loadURDF("data/data/sawyer_robot/sawyer_description/urdf/sawyer.urdf",[0,0,0], [0,0,0,3], useFixedBase = 1)
		...
		self.trayUid = p.loadURDF('/data/data/table2/table.urdf',
								  [1.1,0.,-1],
